...
Amazon OA problem.
  ...
  uv run python amazon_oa/amazon-find-minimum-number-of-operations/solution.py   # debug one case (see CASE below)
  uv run pytest amazon_oa/amazon-find-minimum-number-of-operations/              # run the test sets
"""
