...
if len(CASES) == 0:
    pytest.skip("design-operation example for amazon-find-median-from-data-stream is not `==`-assertable", allow_module_level=True)
...
def test_solution(case):
    try:
        _check(solution.Solution().processMedianOperations, case)
    except NotSolved:
