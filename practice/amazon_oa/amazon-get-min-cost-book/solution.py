...
Amazon OA problem.
  ...
  uv run python amazon_oa/amazon-get-min-cost-book/solution.py   # debug one case (see CASE below)
  uv run pytest amazon_oa/amazon-get-min-cost-book/              # run the test sets
"""
