...
Amazon OA problem.
  ...
  uv run python amazon_oa/amazon-find-minimum-possible-variance/solution.py   # debug one case (see CASE below)
  uv run pytest amazon_oa/amazon-find-minimum-possible-variance/              # run the test sets
"""
