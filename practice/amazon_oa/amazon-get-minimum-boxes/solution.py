...
class Solution:
    def getMinimumBoxes(self, boxes, capacity):
...
if __name__ == "__main__":
    # Debug playground: set a breakpoint in getMinimumBoxes above, then run this file.
    # Pick a case by id (ids are in cases.json).
    CASE = "example_1"
    case = pick_case(__file__, CASE)
    result = Solution().getMinimumBoxes(*case["args"])
