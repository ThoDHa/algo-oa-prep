...
if len(CASES) == 0:
    pytest.skip("design-operation example for amazon-linked-list-queue-operations is not `==`-assertable", allow_module_level=True)
...
def test_solution(case):
    try:
        _check(solution.Solution().processLinkedQueue, case)
    except NotSolved:
