...
if len(CASES) == 0:
    pytest.skip("design-operation example for amazon-employee-ratings-data-structure is not `==`-assertable", allow_module_level=True)
...
def test_solution(case):
    try:
        _check(solution.Solution().employeeRatings, case)
    except NotSolved:
