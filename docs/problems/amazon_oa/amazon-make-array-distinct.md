...
**Explanation:** You can make the size array distinct as {2, 4, 3, 5} with a minimum cost of 7.
...
**Explanation:** You can make the size array distinct as {3, 10, 9, 7, 8} with a minimum cost of 6, which is 2 * (10 - 7) = 6.
