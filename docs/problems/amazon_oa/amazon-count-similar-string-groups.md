...
**Explanation:** "tars" is similar to "rats", and "rats" is similar to "arts", so they form one group. "star" forms another group.
...
**Explanation:** The two strings differ in exactly two positions, so one swap makes them equal.
