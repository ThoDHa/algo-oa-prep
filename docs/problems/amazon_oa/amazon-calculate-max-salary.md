...
If you work in an office and no higher-priority office appears after it in the sequence, you add its salary to your total salary.If you work in an office and a higher-priority office appears later in the sequence, you subtract its salary from your total salary.
...
**Input:** `schedule = "ABCDEEDCBA"`

**Output:** `31000`

**Explanation:** Not found for this time 🙂‍↔️. Lets make a wish to find it in the near future 🎂

If you happen to know about it you are more than welcome to let us know. Thank you so much for carrying! 🤩
