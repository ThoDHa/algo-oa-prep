...
**Explanation:** The string ace appears in both inputs in the same relative order.
...
**Explanation:** The two strings share no character, so the longest common subsequence is empty.
