...
**Explanation:** Data begins at locations listed in locations. Over the course of the year, the data was moved three times.
...
**Explanation:** (ignore the typo in the img)
